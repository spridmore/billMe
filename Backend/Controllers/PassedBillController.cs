...
namespace Bills_Project_Backend.Controllers
{
    ...
    public class LastVersionPassed
    {
        ...
        public Urls2Passed urls { get; set; }
    ...
    public class ResultPassed
    {
        ...
        public ResultPassed history { get; set; }
        ...
        public SponsorPassed sponsor { get; set; }
        public string sponsor_id { get; set; }
        public Urls2Passed urls { get; set; }
        public int withdrawn_cosponsors_count { get; set; }
        public LastVersionPassed last_version { get; set; }
    }
    ...
    {
        public List<ResultPassed> results { get; set; }
        public int count { get; set; }
        public PagePassed page { get; set; }
    }
